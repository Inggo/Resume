...
Vue.component("cube-controls", __webpack_require__(38));
Vue.component("cube-face", __webpack_require__(41));
Vue.component("cube", __webpack_require__(44));
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    controlClass: function controlClass(face) {
      return 'to-' + face;
    }
  }
});
...
var render = function() {
  ...
  return _c(
    ...
    _vm._l(_vm.faces, function(face) {
      return face.name && (_vm.isMobile || face.face != _vm.currentFace)
        ? _c(
            "a",
            {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    cubeClass: function cubeClass() {
      return {
        'cube-container': true,
        'show-front': this.visibleFace == 'front',
        'show-back': this.visibleFace == 'back',
        'show-right': this.visibleFace == 'right',
        'show-left': this.visibleFace == 'left',
        'show-top': this.visibleFace == 'top',
        'show-bottom': this.visibleFace == 'bottom'
      };
    },
...
var render = function() {
  ...
  return _c("div", { staticClass: "main-container" }, [
    _c(
      ...
      { class: _vm.cubeClass },
      _vm._l(_vm.faces, function(face) {
        return _c("cube-face", { key: face.id, attrs: { face: face } })
      })
    )
  ])
}
