...
export default {
  ...
  portfolio: {
    ...
    // Freelance Works
    'Mateship & Bayanihan':                           ['portfolio/mateship-main', 'portfolio/mateship-section'],
    'Taste of Australia':                             ['portfolio/taste-of-australia-1', 'portfolio/taste-of-australia-2'],
    'Stream & Sip Festival':                          ['portfolio/mateship-stream-sip', 'portfolio/mateship-stream-sip-2'],
    ...
    // Sytian IT Solutions
    'Sytian Store':           ['portfolio/sytian-store-harlan-holden', 'portfolio/sytian-store-soak-swimwear'],
    'Sytian Productions':     ['portfolio/sytian-productions'],
    'WordPress Websites':     ['portfolio/sytian-wp-dermstrata', 'portfolio/sytian-wp-celticforest', 'portfolio/sytian-wp-jakinspections', 'portfolio/sytian-wp-tampopo', 'portfolio/sytian-wp-cog'],
    'Customizable Websites':  ['portfolio/sytian-customizable-lotus-garden', 'portfolio/sytian-customizable-northstar', 'portfolio/sytian-customizable-techdive', 'portfolio/sytian-customizable-veritas', 'portfolio/depedbataan'],

    // Personal Works
    'LottoPh':      ['portfolio/personal-lottoph'],
    'Inggo Noms...': ['portfolio/personal-noms'],
    'Ordertaker':   ['portfolio/personal-ordertaker', 'portfolio/personal-ordertaker-mobile', 'portfolio/personal-ordertaker-messenger'],
  },
