  ...
  <div v-if="content" :class="{ 'is-dynamic': overflow }">
    ...
    <ul class="work-contents">
      ...
      >
        ...
        <ul class="work-titles" :ref="(el) => setDyn('titles-' + i, el)">
          <li
...
export default {
  ...
  computed: {
    ...
    lastCompanyIndex() { return this.content.length - 1; },
    lastTitleIndex() { return this.currentCompany.titles.length - 1; },
    hasPrev() { return this.companyIndex > 0 || this.titleIndex > 0; },
    hasNext() {
  ...
  methods: {
    ...
    prev() {
      ...
      if (this.titleIndex == 0) {
        this.companyIndex--;
        this.titleIndex = this.lastTitleIndex;
        this.$refs.contents.forEach((el) => this.animateTranslate(el, -100 * this.companyIndex));
      } else {
        this.titleIndex--;
      }

      if (this.currentTitlesRef) this.animateTranslate(this.currentTitlesRef, -100 * this.titleIndex);
